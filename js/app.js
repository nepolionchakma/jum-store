...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <!-- add rating  -->
      <p> <span class="rating">Rating: ${product.rating.rate}</span> <span class="count">Total Rate: ${product.rating.count}</span></p>
    ...
    const showDetails = document.getElementById('product-details');
    const button = div.childNodes[0].childNodes[15];
